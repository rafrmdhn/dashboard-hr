            ...
            <form action="/form/498c62cf2582c9ef765d1154b0a64032" method="POST" enctype="multipart/form-data">
                ...
                <div class="md:flex mb-8">
                    ...
                    <div class="md:flex-1 mt-2 mb:mt-0 md:px-3">
                        <div class="md:flex mb-4">
                            <div class="md:flex-1 md:pr-3">
                                <label class="block uppercase tracking-wide text-charcoal-darker text-xs font-bold mb-4">Pilih Kategori</label>
                                <div class="grid grid-cols-5 gap-4">
                                    @foreach ($categories as $category)
                                    <div class="flex items-center me-4">
                                        <input id="category_id" name="category_id[]" type="checkbox" value="{{ $category->id }}" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                        <label for="category_id" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">{{ $category->name }}</label>
                                    </div>
                                    @endforeach
                                </div>
                            </div>
                ...
                <div class="md:flex mb-8">
                    <div class="md:w-1/3">
                        <legend class="uppercase tracking-wide text-sm">Apakah kamu berminat menjadi talent prioritas?</legend>
                        <span class="text-xs mb-4 font-thin">Exclusive Talent akan diprioritaskan untuk diajukan kepada brand dan berhak mengikuti exclusive event FYP Media x Brand Ternama. Persyaratan: mencantumkan CP 085175123014 (Jaya) dan @fypmedia.id di bio instagram</span>
                    </div>
                    <div class="md:flex-1 mt-2 mb:mt-0 md:px-3">
                        <div class="md:flex mb-4">
                            <div class="md:flex-1 md:pr-3">
                ...
                <div class="md:flex mb-8">
                    <div class="md:w-1/3">
                        ...
                        <span class="text-xs mb-4 font-thin">Setelah Submit, konfirmasi ke Nomor 085175460533 (Fia) ya. <a href="http://wa.me/6285175460533" class="text-blue-800">(wa.me/6285175460533)</a></span>
                    </div>
                    <div class="md:flex-1 mt-2 mb:mt-0 md:px-3">
                        <div class="md:flex mb-4">
                            <div class="md:flex-1 md:pr-3">
                ...
                <div class="md:flex border border-t-1 border-b-0 border-x-0 border-cream-dark">
                    <div class="md:flex-1 px-3 text-center md:text-right">
                        <button type="submit" class="text-white bg-gray-800 hover:bg-black focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mt-4 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Kirim</button>
                    </div>
                </div>
            </form>
        </section>
