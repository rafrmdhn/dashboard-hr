                ...
                <form action="/brand/{{ $brand->id }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-6 gap-6">
                            ...
                            <select name="position_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <option selected>Choose a Position</option>
                                    @foreach ($positions as $position)
                                        @if (old('position_id', $brand->position_id) == $position->id)
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="text" name="university" value="{{ old('university', $brand->university) }}" id="university" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="e.g. Universitas Indonesia" required>
                        </div>
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="text" name="instagram" value="{{ old('instagram', $brand->instagram) }}" id="instagram" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="e.g. @fypmedia.id" required>
                            </div>
                        </div>
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="text" name="linkedin" value="{{ old('linkedin', $brand->linkedin) }}" id="linkedin" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="e.g. fyp-media-corp" required>
                            </div>
                        </div>
