    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        ...
        <li>
            ...
            <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                ...
                <span class="flex-1 ms-4 text-left rtl:text-right whitespace-nowrap">Data</span>
        ...
        <li>
            <a href="/fregistrasi" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ Request::is('fregistrasi') ? 'bg-gray-200 hover:text-gray-600' : '' }}">
                ...
                <span class="ms-3 whitespace-nowrap">Form Registrasi</span>
            </a>
        </li>
        {{-- <li>
        ...
        <li>
            @auth
                <form action="/logout" method="POST" class="pb-4">
                    @csrf
                    <button type="submit" class="flex items-center w-full p-2 text-base transition duration-75 rounded-lg group hover:bg-red-100 hover:text-red-600 dark:hover:bg-red-700">
