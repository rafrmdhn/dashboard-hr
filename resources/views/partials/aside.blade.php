<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        ...
        <li>
            ...
            <a href="/" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ Request::is('/') ? 'bg-gray-200' : '' }}">
        ...
        <li>
          ...
          <ul id="dropdown-example" class=" {{ Request::is('talent*') || Request::is('staff*') || Request::is('intern*') ? '' :'hidden' }} py-2 space-y-2">
                <li>
                   <a href="/talent" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 {{ Request::is('talent') ? 'bg-gray-200' : '' }}">Talent</a>
                </li>
                <li>
                   <a href="/staff" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 {{ Request::is('staff') ? 'bg-gray-200' : '' }}">Karyawan</a>
                </li>
                <li>
